...
router.post("/", uploadLabReport.single("reportFile"), asyncHandler(PrescriptionController.create));
...
router.put("/:id", uploadLabReport.single("reportFile"), asyncHandler(PrescriptionController.update));
